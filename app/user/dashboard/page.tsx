...
// to show different views for different routes , like sidenavigation links content will be rendered here

// below i am using UserProvider useContext wrapper function so that currentUserId will be avilable inside the page of dashbaord, like in render window
