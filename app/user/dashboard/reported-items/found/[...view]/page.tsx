  ...
  const viewItem:FoundItem = foundItems[index];
    ...
    return (
              <div className="container py-5 px-20 flex items-center justify-center">
                ...
                {viewItem && (<div className="container py-5 px-20 flex items-center justify-center">
  {/* Use max-w-7xl to limit the width of the container */}
  {viewItem && (
    <div className="bg-white transition shadow-xl flex rounded-lg w-full max-w-7xl max-h-[450px]">
      {/* Column 1: Image */}
